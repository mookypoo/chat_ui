...
class IosChatListTile extends StatefulWidget{
  ...
  @override
  State<IosChatListTile> createState() => _IosChatListTileState();
}

class _IosChatListTileState extends State<IosChatListTile>{
    ...
    return GestureDetector(
      onTap: () async {
        await Navigator.of(context).pushNamed(
          ...
          arguments: widget.messageData.name,
        );
      },
      child: Container(
              ...
              Stack(
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(widget.messageData.profileImage,),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    Positioned(
                      ...
                      right: 10.0,
                      child: Stack(
                        children: widget.messageData.online ? <Widget>[
                          Container(
                            width: 20.0,
                            height: 20.0,
                            decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              child: Container(
                                child: Text(widget.messageData.name, style: TextStyle(fontWeight: FontWeight.bold)),
                              ),
                            ),
                            Text(
                              MessageService.covertTimeToString(time: widget.messageData.lastMsgTime),
                      ...
                      Container(
                        ...
                        child: Text(
                            widget.messageData.lastMessage,
                            softWrap: true,
                            maxLines: 2,
